...
use Illuminate\Support\Facades\DB; //esto no es necesario porque no estamos buscando nada en la BD
  
class FormatTime { //el provider tiene que tener el nombre de esta clase, el provider de este helper se llama FormatTimeServiceProvider
